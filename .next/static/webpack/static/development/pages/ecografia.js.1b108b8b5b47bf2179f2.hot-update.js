...
})(["font-family:\"Monserrat-Regular\";.ecography-img{width:100%;object-fit:cover;}h2{font-family:\"Monserrat-Semibold\";color:#740a64;letter-spacing:0.2px;}.treatment-name{font-family:\"Monserrat-Semibold\";color:#740a64;}.ecography-content{width:90%;margin:0 auto;}.back-photo{background-image:url(", ");background-size:cover;background-position:center;object-fit:cover;}li{list-style:none;letter-spacing:0.2px;margin-top:2%;margin-bottom:2%;}@media only screen and (min-width:415px) and (max-width:768px){.ecography{display:flex;flex-wrap:wrap;justify-content:space-between;}}@media only screen and (min-width:769px) and (max-width:1440px){.ecography-img{height:50vh;}.ecography-content{width:60%;margin-left:5%;}.ecography{display:flex;flex-wrap:wrap;justify-content:space-between;}}@media only screen and (min-width:1441px){.ecography-img{height:50vh;}.ecography-content{width:60%;margin-left:5%;}.ecography{display:flex;flex-wrap:wrap;justify-content:space-between;}}"], _static_imgEcografi_a2_jpg__WEBPACK_IMPORTED_MODULE_1___default.a);
/* harmony default export */ __webpack_exports__["default"] = (EcographyStyles);

/***/ })

})
//# sourceMappingURL=ecografia.js.1b108b8b5b47bf2179f2.hot-update.js.map