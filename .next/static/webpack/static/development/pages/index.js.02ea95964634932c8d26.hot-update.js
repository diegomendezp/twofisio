...
var _bubleAnimation = function _bubleAnimation(posX, posY, fromScaleY, toScaleY, fromScaleX, toScaleX) {
  Object(popmotion__WEBPACK_IMPORTED_MODULE_0__["tween"])({
    ...
    if (document.getElementById('target') !== null) {
      document.getElementById('target').style.webkitTransform = "translate(".concat(posX, "px, ").concat(posY, "px) scale(").concat(v.scaleY, ",").concat(v.scaleX, ")");
    }
  });
};
...
//# sourceMappingURL=index.js.02ea95964634932c8d26.hot-update.js.map