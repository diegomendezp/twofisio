    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth <= 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          document.getElementById("target").style.transform = "translate(1px, ".concat(_this2.state.vh, "px) scaleY(").concat(v.scaleY, ") scaleX(").concat(v.scaleX, ")");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
...
//# sourceMappingURL=index.js.062b5af4492fb8cfd802.hot-update.js.map