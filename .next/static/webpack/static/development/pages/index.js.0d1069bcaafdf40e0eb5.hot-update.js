    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth < 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          document.getElementById("target").style.transform = "translate(".concat(_this2.state.vw + 850, "px, ").concat(_this2.state.vh / 2, "px) scale(").concat(v.scale, ") scaleX(0.3)");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
          ...
          document.getElementById("target").style.transform = "translate(500px, -100px) scale(".concat(v.scale, ")");
        });
...
//# sourceMappingURL=index.js.0d1069bcaafdf40e0eb5.hot-update.js.map