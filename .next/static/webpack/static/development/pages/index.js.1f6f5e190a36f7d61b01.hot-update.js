...
var _bubleAnimation = function _bubleAnimation(posX, posY, fromScaleY, toScaleY, fromScaleX, toScaleX) {
  Object(popmotion__WEBPACK_IMPORTED_MODULE_0__["tween"])({
    ...
    if (document.getElementById('group') !== null) {
      document.getElementById('group').style.webkitTransform = "translate(".concat(posX, "px, ").concat(posY, "px) scaleY(").concat(v.scaleY, ") scaleX(").concat(v.scaleX, ")");
    }
  });
};
...
//# sourceMappingURL=index.js.1f6f5e190a36f7d61b01.hot-update.js.map