    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth < 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          document.getElementById("target").style.transform = "translate(".concat(_this2.state.vw, "px, ").concat(_this2.state.vh / 2, "px) scale(").concat(v.scale, ")");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
...
//# sourceMappingURL=index.js.400cb7fb6cf24718e5b6.hot-update.js.map