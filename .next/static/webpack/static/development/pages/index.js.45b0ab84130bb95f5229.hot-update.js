    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth < 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          console.log(v);
          document.getElementById("target").style.transform = "translate(300px, -100px) scaleY(".concat(v.scaleY, ") scaleX(").concat(v.scaleX, ")");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
...
//# sourceMappingURL=index.js.45b0ab84130bb95f5229.hot-update.js.map