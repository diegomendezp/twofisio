    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth < 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          document.getElementById("target").style.transform = "translate(".concat(_this2.state.vw + 850, "px, ").concat(_this2.state.vh / 2, "px) scaleY(").concat(v.scale, ") scaleX(1)");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
          ...
          document.getElementById("target").style.transform = "translate(500px, -100px) scaleY(".concat(v.scale, ") scaleY(").concat(v.scale - 1, ")");
        });
...
//# sourceMappingURL=index.js.59bb3ac22b7cc4bf6d09.hot-update.js.map