    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth < 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          console.log(v);
          document.getElementById("target").style.transform = "translate(100px, 1px) scaleY(".concat(v.scaleY, ") scaleX(").concat(v.scaleX, ")");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
...
//# sourceMappingURL=index.js.5aff89885b9afe38a4a0.hot-update.js.map