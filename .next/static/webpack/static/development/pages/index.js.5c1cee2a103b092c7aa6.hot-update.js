...
var displayContactElements = function displayContactElements(contactList) {
  return contactList.map(function (element, i) {
    //   return element === "Dirección" ? <a href="https://goo.gl/maps/K6zbJ39jVTn" target="_blank">
    //   Dirección: Avenida del Padre Piquer, 39, 28024 Madrid
    // </a> : <li><p>{element}</p>
    // <p>contactList[element]</p></li>
    console.log(element);
  });
};

var Footer = function Footer() {
  console.log(Object(_content_contact_json__WEBPACK_IMPORTED_MODULE_2__).keys());
...
//# sourceMappingURL=index.js.5c1cee2a103b092c7aa6.hot-update.js.map