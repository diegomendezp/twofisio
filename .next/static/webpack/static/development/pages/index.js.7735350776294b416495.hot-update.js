...
var _bubleAnimation = function _bubleAnimation(posX, posY, fromScaleY, toScaleY, fromScaleX, toScaleX) {
  Object(popmotion__WEBPACK_IMPORTED_MODULE_0__["tween"])({
    ...
    if (document.getElementById('target') !== null) {
      document.getElementById('target').style.webkitTransform = "translate3d(".concat(posX, "px, ").concat(posY, "px, 0)");
    }
  });
};
...
//# sourceMappingURL=index.js.7735350776294b416495.hot-update.js.map