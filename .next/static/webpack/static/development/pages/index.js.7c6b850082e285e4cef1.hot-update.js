...
function (_Component) {
  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "_listenSliderButtons", function () {
      console.log(document.getElementsByClassName("bubbleGroup")); // document.getElementById("bubbleGroup").onclick = (event) => {
      //   var target = this._getEventTarget(event);
...
//# sourceMappingURL=index.js.7c6b850082e285e4cef1.hot-update.js.map