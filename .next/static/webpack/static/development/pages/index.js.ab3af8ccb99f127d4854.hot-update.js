...
var _bubleAnimation = function _bubleAnimation(posX, posY, fromScaleY, toScaleY, fromScaleX, toScaleX) {
  Object(popmotion__WEBPACK_IMPORTED_MODULE_0__["tween"])({
    ...
    if (document.getElementById('target') !== null) {
      ...
      sdocument.getElementById('target').style.webkitTransform = "translate(".concat(posX, "px, ").concat(posY, "px) scaleY(").concat(v.scaleY, ") scaleX(").concat(v.scaleX, ")");
    }
  });
};
...
//# sourceMappingURL=index.js.ab3af8ccb99f127d4854.hot-update.js.map