    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth < 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          document.getElementById("target").style.transform = "translate(".concat(_this2.state.vw - 100, "px, ").concat(_this2.state.vh / 2, "px) scale(").concat(v.scale, ") scaleY(8)");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
...
//# sourceMappingURL=index.js.cdcbea87256c975d84cb.hot-update.js.map