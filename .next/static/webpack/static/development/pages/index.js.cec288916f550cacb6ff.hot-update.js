...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Home, [{
    key: "_changeBubble",
    value: function _changeBubble() {
      console.log("Posicion +", this.state.formPosition + 1);
      console.log(document.querySelectorAll(".bubble"));

      if (this.state.formPosition === 3) {
        document.querySelectorAll(".bubble")[this.state.formPosition].className = "bubble";
        document.querySelectorAll(".bubble")[0].className = "bubble active";
      } else {
        document.querySelectorAll(".bubble")[this.state.formPosition].className = "bubble";
        document.querySelectorAll(".bubble")[this.state.formPosition + 1].className = "bubble active";
      }
    }
  }, {
    key: "_positioningSVG",
...
//# sourceMappingURL=index.js.cec288916f550cacb6ff.hot-update.js.map