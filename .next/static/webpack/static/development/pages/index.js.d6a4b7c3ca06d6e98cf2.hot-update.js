    ...
    value: function componentDidMount() {
      ...
      if (window.innerWidth < 768) {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          ...
          console.log(v);
          document.getElementById("target").style.transform = "translate(100px, -100px) scaleY(".concat(v.scaleY, ") scaleX(").concat(v.scaleX, ")");
        });
      } else {
        Object(popmotion__WEBPACK_IMPORTED_MODULE_11__["tween"])({
          from: {
...
//# sourceMappingURL=index.js.d6a4b7c3ca06d6e98cf2.hot-update.js.map