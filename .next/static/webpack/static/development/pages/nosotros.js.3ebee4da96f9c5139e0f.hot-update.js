...
})(["font-family:\"Monserrat-Regular\";color:", ";font-size:0.8rem;letter-spacing:0.04rem;line-height:1.3rem;@media only screen and (min-width:414px) and (max-width:768px){font-size:1rem;}@media only screen and (min-width:769px) and (max-width:1024px){font-size:1rem;}@media only screen and (min-width:1025px) and (max-width:1440px){font-size:1rem;}@media only screen and (min-width:1441px){font-size:1rem;}"], function (props) {
...
//# sourceMappingURL=nosotros.js.3ebee4da96f9c5139e0f.hot-update.js.map