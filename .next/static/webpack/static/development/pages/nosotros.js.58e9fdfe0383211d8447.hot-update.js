...
})(["font-family:\"Monserrat-Regular\";color:", ";font-size:0.8rem;letter-spacing:0.04rem;line-height:1.3rem;@media only screen and (min-width:415px) and (max-width:768px){font-size:1rem;}@media only screen and (min-width:769px) and (max-width:1024px){font-size:1rem;}@media only screen and (min-width:1025px) and (max-width:1440px){font-size:1rem;}@media only screen and (min-width:1441px){font-size:1rem;}"], function (props) {
...
//# sourceMappingURL=nosotros.js.58e9fdfe0383211d8447.hot-update.js.map