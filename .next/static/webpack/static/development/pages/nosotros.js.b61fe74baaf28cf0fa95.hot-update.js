...
var rotateImage = function rotateImage(id) {
  document.querySelector(id).style.webkitTransform = "rotate(90deg)";
};
...
var Member = function Member(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
    ...
    onClick: function onClick() {
      rotateImage("\xB7up-down-icon-".concat(name));
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25
...
//# sourceMappingURL=nosotros.js.b61fe74baaf28cf0fa95.hot-update.js.map