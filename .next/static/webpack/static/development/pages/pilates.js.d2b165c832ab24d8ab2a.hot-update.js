...
})(["position:relative;width:100vw;height:50vh;background-image:url(", ");-webkit-clip-path:url(#svgPath);background-position-y:", "%;background-size:100%;#container{position:absolute;top:0;left:0;width:100%;height:100vh;}@media only screen and (max-width:415px){background-position-x:28%;background-size:196%;height:50vh;}@media only screen and (min-width:415px) and (max-width:768px){height:33vh;background-position-y:0%;}@media only screen and (min-width:769px) and (max-width:1023px){height:90vh;}@media only screen and (min-width:1024px) and (max-width:1440px){height:63vh;}@media only screen and (min-width:1441px){height:90vh;}"], function (props) {
...
//# sourceMappingURL=pilates.js.d2b165c832ab24d8ab2a.hot-update.js.map